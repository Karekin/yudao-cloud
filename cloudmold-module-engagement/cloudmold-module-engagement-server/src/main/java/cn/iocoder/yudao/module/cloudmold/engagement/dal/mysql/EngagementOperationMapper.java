...
import cn.iocoder.yudao.module.cloudmold.engagement.dal.dataobject.EngagementOperationDO;
import org.apache.ibatis.annotations.*;

import java.time.LocalDateTime;

@Mapper
public interface EngagementOperationMapper extends BaseMapperX<EngagementOperationDO> {

    @Insert("""
            INSERT INTO cloudmold_engagement_operation
    ...
    @Select("""
            ...
            FROM cloudmold_engagement_operation
            WHERE operation_id=#{operationId} AND tenant_id=#{tenantId}
            FOR UPDATE
            """)
    EngagementOperationDO selectForUpdate(@Param("operationId") Long operationId,
                                          @Param("tenantId") Long tenantId);

    @Update("""
            UPDATE cloudmold_engagement_operation
