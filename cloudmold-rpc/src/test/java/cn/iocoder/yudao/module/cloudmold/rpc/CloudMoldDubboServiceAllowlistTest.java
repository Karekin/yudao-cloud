    ...
    void shouldLoadEveryCloudMoldPublicApiContractName() {
        ...
        assertThat(services).hasSizeGreaterThanOrEqualTo(100)
                .contains("cn.iocoder.yudao.module.cloudmold.agentcontrol.api.workflow.MissionLifecycleWorkflowCommandApi",
                        ...
                        "cn.iocoder.yudao.module.cloudmold.procurement.api.SourcingCommandApi",
                        "cn.iocoder.yudao.module.cloudmold.procurement.api.SourcingQueryApi",
                        "cn.iocoder.yudao.module.cloudmold.inventory.api.InventoryProcurementReceiptApi",
                        "cn.iocoder.yudao.module.cloudmold.inventory.api.InventoryStockTransferApi",
                        "cn.iocoder.yudao.module.cloudmold.quality.api.ProcurementReceiptInspectionCommandApi",
                        "cn.iocoder.yudao.module.cloudmold.quality.api.ProcurementReceiptInspectionQueryApi",
                        "cn.iocoder.yudao.module.cloudmold.warehouse.api.StockTransferCommandApi",
                        "cn.iocoder.yudao.module.cloudmold.warehouse.api.StockTransferQueryApi",
                        "cn.iocoder.yudao.module.cloudmold.warehouse.api.WarehouseProcurementQualityDecisionApi",
                        "cn.iocoder.yudao.module.cloudmold.finance.api.p2p.JournalCommandApi",
                        "cn.iocoder.yudao.module.cloudmold.finance.api.p2p.P2pEvidenceIngestionApi",
                        "cn.iocoder.yudao.module.cloudmold.finance.api.p2p.P2pFinanceSetupCommandApi",
                        "cn.iocoder.yudao.module.cloudmold.finance.api.p2p.SupplierInvoiceCommandApi",
                        "cn.iocoder.yudao.module.cloudmold.finance.api.p2p.SupplierPaymentCommandApi",
                        "cn.iocoder.yudao.module.cloudmold.supplier.api.SupplierProfileCommandApi",
                        "cn.iocoder.yudao.module.cloudmold.supplier.api.SupplierProfileQueryApi",
