...
This red-zone module is the canonical authority for tenant-scoped customer-service tickets, qualified Order/AfterSale links, message and attachment metadata, quality reviews, claims, and an append-only service-compensation ledger. It does not import another module's DO, Mapper, or internal service.
...
All five events use schema v1, source `cloudmold-customer-service`, the shared transactional Outbox, and PII-safe payloads:
