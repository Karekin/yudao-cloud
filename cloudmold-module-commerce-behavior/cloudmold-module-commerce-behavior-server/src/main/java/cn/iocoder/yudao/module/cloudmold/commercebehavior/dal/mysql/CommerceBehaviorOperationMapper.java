...
import cn.iocoder.yudao.module.cloudmold.commercebehavior.dal.dataobject.CommerceBehaviorOperationDO;
import org.apache.ibatis.annotations.*;

import java.time.LocalDateTime;

@Mapper
public interface CommerceBehaviorOperationMapper extends BaseMapperX<CommerceBehaviorOperationDO> {

    @Insert("""
            INSERT INTO cloudmold_commerce_behavior_operation
    ...
    @Select("""
            ...
            FROM cloudmold_commerce_behavior_operation
            WHERE operation_id=#{operationId} AND tenant_id=#{tenantId}
            FOR UPDATE
            """)
    CommerceBehaviorOperationDO selectForUpdate(@Param("operationId") Long operationId,
                                                @Param("tenantId") Long tenantId);

    @Update("""
            UPDATE cloudmold_commerce_behavior_operation
