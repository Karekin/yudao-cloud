...
public class CanonicalWarehouseActorPrincipalAdapter implements WarehouseActorPrincipalPort {
    ...
    public String resolveSystemAdmin(Long loginUserId) {
        ...
        if (source == null || source.getPrincipalId() == null || source.getPrincipalId().isBlank()
                || !"ACTIVE".equals(source.getPrincipalStatus()) || !"ACTIVE".equals(source.getSourceStatus())) {
