CREATE TABLE IF NOT EXISTS cloudmold_partner_marketing_operation (
  ...
  COMMENT='Idempotent canonical partner marketing command envelope';

CREATE TABLE IF NOT EXISTS cloudmold_partner_marketing_case (
  ...
  COMMENT='Canonical partner marketing workflow owned by KOL / influencer operator';

CREATE TABLE IF NOT EXISTS cloudmold_partner_marketing_case_history (
  ...
  COMMENT='Append-only canonical partner marketing workflow status history';
